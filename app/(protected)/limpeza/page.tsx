...
import { Calendar, BrushIcon as Broom, Clock, Users, CheckCircle2 } from "lucide-react"
...
const escalas = [
  ...
  },
  {
    ...
    area: "Cozinha",
    responsaveis: [
      { nome: "Carlos Silva", avatar: "/placeholder.svg?height=40&width=40", iniciais: "CS" },
      { nome: "Fernanda Lima", avatar: "/placeholder.svg?height=40&width=40", iniciais: "FL" },
    ],
    tarefas: ["Limpar fogão e geladeira", "Organizar armários", "Lavar louças"],
    status: "pendente",
  },
  {
    id: 3,
    ...
    area: "Área Externa",
    responsaveis: [
      { nome: "Roberto Santos", avatar: "/placeholder.svg?height=40&width=40", iniciais: "RS" },
      { nome: "Juliana Costa", avatar: "/placeholder.svg?height=40&width=40", iniciais: "JC" },
      { nome: "Pedro Alves", avatar: "/placeholder.svg?height=40&width=40", iniciais: "PA" },
    ],
    tarefas: ["Varrer o quintal", "Limpar os assentamentos externos", "Cuidar do jardim"],
    status: "pendente",
  },
  {
    id: 4,
    ...
    responsaveis: [
      { nome: "Ana Clara", avatar: "/placeholder.svg?height=40&width=40", iniciais: "AC" },
      { nome: "Carlos Tranca Ruas", avatar: "/placeholder.svg?height=40&width=40", iniciais: "CT" },
    ],
    tarefas: ["Varrer o salão", "Limpar os assentamentos", "Organizar as cadeiras"],
    status: "pendente",
  },
