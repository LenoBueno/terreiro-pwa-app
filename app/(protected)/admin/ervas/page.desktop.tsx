...
export default function AdminErvasDesktop() {
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-left align-middle font-medium text-muted-foreground px-4">Propriedades</TableHead>
              <TableHead className="text-left align-middle font-medium text-muted-foreground px-4">Indicações</TableHead>
          ...
          <TableBody>
            {filteredErvas.map((erva) => (
              <TableRow key={erva.id}>
                ...
                <TableCell className="text-left align-middle px-4">{erva.propriedades}</TableCell>
                <TableCell className="text-left align-middle px-4">{erva.indicacoes}</TableCell>
